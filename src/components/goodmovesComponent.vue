...
<div class="container-fluid mt-3">
    ...
    <div class="table-responsive shadow-sm rounded">
        <table class="table table-striped table-hover align-middle border">
            ...
            <tbody>
                <tr v-for="acc in goodmoves" :key="acc.id">
                    <td>{{acc.nameStockFrom}}</td>
                    <td>{{acc.nameStockTowhere}}</td>
                    <td>{{acc.nameGood}}</td>
                    <td class="text-center fw-bold">{{acc.qty}}</td>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body p-4">
                    <div class="input-group mb-3">
                        <span class="input-group-text w-25 bg-light fw-bold small">Откуда</span>
                        <select class="form-select" v-model="nameStockFrom">
                            <option v-for="st in stocks" :key="st.id" :value="st.nameStock">{{st.nameStock}}</option>
                        </select>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text w-25 bg-light fw-bold small">Куда</span>
